...
@section('content')
    ...
    <div style="width: 100%;height: 100vh;position: relative;">
        <form id="upBox">
            ...
            <div id="inputBox"><input type="file" title="请选择图片" id="file" multiple
                                      accept="image/png,image/jpg,image/gif,image/JPEG"/>点击选择图片
            </div>
            <div id="imgBox"></div>
            <a id="btn">上传</a>
            <input id="btn" type="button" class="back" onclick="history.go(-1)" value="返回">
        </form>
    </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.status == 0) {
                            ...
                            //window.localtion.href = "{{url('admin/goods')}}";
                            setTimeout(function () {
