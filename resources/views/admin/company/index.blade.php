...
@section('content')
    ...
    <xblock>
        ...
        <a href="{{url('admin/company/add')}}" i class="layui-btn layui-icon">添加</a>
    ...
    <table class="layui-table">
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="td-manage">
                    <a title="编辑" href="{{url('admin/company/'.'/edit ')}}">
                        <i class="layui-icon">&#xe642;</i>
                    </a>
                    <a title="删除"  href="javascript:;" onclick="member_del({{$v->company_id}});">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
    ...
    <script>
        ...
        function member_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.post("{{url('admin/company/del')}}/"+obj,{'_method':'delete','_token':"{{csrf_token()}}"},function(data){
                    if (data.status ==0){
